...
epsilon=1
# total number of visits to particular state during whole training
...
for K in range(episode):
    ...
    # time-out
    truncated=False
    # measure of time in each episode or number of steps
    time=0
    while not (terminated or truncated):
        ...
        # storing all the visited states in a episodes for update
